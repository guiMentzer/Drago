...
## 'drago_description_pkg' 

O pacote 'drago_description_pkg' contém o arquivo URDF do robô, com a pasta **meshes** contendo os arquivos STL dos elos. Ademais, contém um *launch* para a visualição do robô (Rviz) com o controle das juntas (Joint State Publisher).  
...
Este pacote contém o código para gerar uma rotina de movimentos inteligente, usando o **MTC (MoveIt Task Constructor)**. Contém um código exemplo de como criar estágios (stages) e executá-los e outro código com uma tarefa exemplo, iterando entre diferentes posições e rotacionando sobre eixos. 
